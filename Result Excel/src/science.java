...
class science extends JFrame{
	 ...
	 JLabel l1,l2,l3,l4,l5,l6,l7,l8,l9;
	    ...
	    public science(JFrame frame)
	    {

	        final  JTable table=new JTable();
	  final DefaultTableModel model=new DefaultTableModel();
	  Object[] column={" Roll "," ICT "," Physics "," Chemistry "," Mathematics "," Biology "," Total "};
	  ...
	  table.setRowHeight(20);
	      ...
	      add(l1);
	      l2=new JLabel("Ict score :");
	      l2.setBounds(10,380,200,25);
	      add(l2);
	      l3=new JLabel("Physics score :");
	      l3.setBounds(10,410,200,25);
	      add(l3);
	      l4=new JLabel("Chemistry score :");
	      l4.setBounds(10,440,200,25);
	      add(l4);
	      l5=new JLabel("Mathematics score :");
	      l5.setBounds(10,470,200,25);
	      add(l5);
	      l6=new JLabel("Biology score :");
